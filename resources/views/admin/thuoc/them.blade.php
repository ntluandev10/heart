            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-block">
                        <form action="admin/thuoc/them" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Tên thuốc</label>
                                <div class="col-sm-10">
                                    <input type="text" name="Tenthuoc" class="form-control" placeholder="Nhập tên thuốc">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="Link" id="" placeholder="Nhập link của thuốc" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
